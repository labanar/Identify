...
{
    public class Pbkdf2HashingService_HMACSHA1_1000 : IHashingService
    {
        public Pbkdf2HashingService_HMACSHA1_1000()
        {
        ...
        public Task<Hash> CreateHash(string plainText)
        {
            ...
            return Task.FromResult(new Hash
            {
                ...
                HashingAlgorithm = HashingAlgorithm.PBKDF2_HMACSHA1_1000
            });
        }
    }
}
